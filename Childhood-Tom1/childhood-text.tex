...
During dessert, Yakov was called in and ordered to bring up the brake, the dogs, and the saddle horses---all in the greatest detail, calling each horse by name. Volodya's horse had a limp; \textit{papa} gave orders for a hunter to be saddled for him. That word, ``hunter horse,'' sounded strange in \textit{maman}'s \todo{correct formatting?} ears: it seemed to her that a hunter horse must be some kind of wild beast, and that it would definitely bolt and kill Volodya. Despite assurances from \textit{papa} and Volodya, who with astonishing bravado said that it was nothing to him and that he loved it when a horse bolted, poor \textit{maman} repeated over and over that she would be suffering the entire trip.
