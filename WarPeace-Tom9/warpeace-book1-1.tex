...
heard behind sympathy and politeness. %vasily
...
to her by name, slowly turning her eyes from them to \textit{ma
  tante,} and then left. %annapavlovna
...
The young Princess Bolkonskaya arrived with her work in a velvet bag
...
\textit{``Soyez tranquille, Lise, vous serez toujours la plus
  ...
  will always be the prettiest. \textit{Fr.}} %annapavlovna
...
Pavlovna, fearful, spoke to stop him: %annapavlovna
...
interesting, but hardly possible\ldots{}'' %pierre
...
he considered the abbot's plan a chimera. %annapavlovna
